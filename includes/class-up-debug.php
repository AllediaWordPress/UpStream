...
<?php
    ...
    protected static function handle_actions()
    {
        ...
        $pageParam = 'page';
        if ( ! array_key_exists($pageParam, $_GET) || sanitize_text_field($_GET[$pageParam]) !== static::PAGE_SLUG) {
            return;
        }
        ...
        $action = preg_replace('/[^a-z0-9_\-]/i', '', sanitize_text_field($_GET[$actionParam]));
